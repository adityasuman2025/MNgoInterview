...
export default function TopicSubNavbar() {
    return (
        <div className="border-y border-ternary bg-ternary/80 backdrop-blur-md px-4 md:px-8 py-1 flex items-center justify-between text-xs transition-colors shadow-xs">
            <ModeSwitchButton />
            <TimerControls />
        </div>
    );
